...
Latest release: **[v1.0.8](https://github.com/LondonVista/iPhoneBatteryWidget/releases/latest)**

| Platform | Format | Size | Download Link |
| :--- | :--- | :--- | :--- |
| 🍏 **macOS (Apple Silicon)** | `.dmg` Installer | — | **[⬇️ Download iPhoneBatteryWidget-Installer.dmg](https://github.com/LondonVista/iPhoneBatteryWidget/releases/download/v1.0.8/iPhoneBatteryWidget-Installer.dmg)** |
| 🍏 **macOS (Apple Silicon)** | `.app` zip | — | **[⬇️ Download iPhoneBatteryWidget.app.zip](https://github.com/LondonVista/iPhoneBatteryWidget/releases/download/v1.0.8/iPhoneBatteryWidget.app.zip)** |
