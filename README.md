...
Latest release: **[v1.0.2](https://github.com/LondonVista/iPhoneBatteryWidget/releases/latest)**

| Platform | Format | Size | Download Link |
| :--- | :--- | :--- | :--- |
| 🍏 **macOS (Apple Silicon)** | `.dmg` Installer | 2.7 MB | **[⬇️ Download iPhoneBatteryWidget-Installer.dmg](https://github.com/LondonVista/iPhoneBatteryWidget/releases/download/v1.0.2/iPhoneBatteryWidget-Installer.dmg)** |
